...
//@Composable means this function describes part of the apps UI
@Composable
fun CityListScreen(
    ...
    // Used by onDeleteCity to know which city is selected
    var cityRemoveName by remember { mutableStateOf("")}
    ...
    Column(modifier = modifier.fillMaxSize()) {
        Row(modifier = Modifier.padding(16.dp)) {
            ...
            // Makes each of the entries
            Button(
                onClick = {
                    if (cityRemoveName.isNotBlank()) {
                        onDeleteCity(cityRemoveName)
                        cityRemoveName = ""
                    }
                }
            ) {
...
//    //var cityToBeRemoved by remember {mutableStateOf("")}
//    Button(
//        onClick = {
//        }
//    ) {
